...
public class SalesSelfCareActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		{	
			...
			try {
				...
				ws.setL_IMSI("634021450155813"); // I should set IMSI later
			...
			Toast.makeText(getBaseContext(), "MSISDN" + MSISDN+ "PIN"+PIN,Toast.LENGTH_SHORT).show();
				}
			}catch (Exception e) {
