	...
	public void onCreate(Bundle savedInstanceState) {
	  ...
	  //Scan_btn = (Button) findViewById(R.id.scan);
		...
		agree_checkbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
		 ...
		 IMSI = "51566545646546";//telephonyManager.getSubscriberId();
	    // telephonyManager.getSimSerialNumber();
		 NAME = "NAme";//name.getText().toString(); 
		 MSISDN ="92929292";//msisdn.getText().toString(); 
		 SERAIL ="165161";//serail.getText().toString(); 
		 ADDRESS = "NAme";//address.getText().toString(); 
		 FrontImageName = "ery";//IMSI + "_" + MSISDN;
		 BackImageName = "trytry";//IMSI + "_" + MSISDN;		 
